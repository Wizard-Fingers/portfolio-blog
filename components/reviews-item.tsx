    ...
    <section className="flex flex-col h-full p-4 bg-brandCol1 dark:bg-brandCol3 shadow-md rounded-lg m-2 lg:m-4">
      ...
      <div className="flex items-center mb-4 relative">
        ...
        <Link href={linkedin} target="_blank">
          <div className="absolute top-0 left-0 translate-x-[3rem] translate-y-[3rem]  dark:bg-brandCol5 bg-brandCol4 hover:bg-brandCol5 dark:hover:bg-brandCol6 w-8 h-8 flex justify-center items-center rounded-full border-2 border-brandCol1 shadow-md">
            <Icons.linkedin />
          </div>
        </Link>
        <div className="ml-2">
      ...
      <section className="flex-1">
        <div className="flex justify-start -translate-x-[0.1rem] text-brandCol5 dark:text-brandCol4">
          <FaQuoteLeft size={24} />
        </div>
        <div className="mt-2 mb-4 border-l-2 border-brandCol5 dark:border-brandCol4  pl-4">
