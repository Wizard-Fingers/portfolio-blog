      ...
      <div className="container max-w-4xl py-6 lg:py-10 border-l border-dashed border-brandCol2 dark:border-brandCol1 dash-spacing">
        ...
        <div className="space-y-4">
          ...
          <p>
            ...
            been building websites for over 5 years now and I love every minute
            of it.
          </p>
        </div>
        <div className="w-full h-[1px] dark:bg-brandCol4 bg-brandCol5 rounded-full my-4" />
        ...
        <div className="space-y-4 my-2">
          ...
          <p>
            ...
            online. I believe that the web is a powerful tool that can be used
            to make a positive impact on you and the world.
          </p>
        </div>
        <div className="w-full h-[1px] dark:bg-brandCol4 bg-brandCol5 rounded-full my-4" />
        <div>
          <h2 className="text-2xl my-8 header-font">My Timeline</h2>
        </div>
        <Timeline />
      </div>
    </>
