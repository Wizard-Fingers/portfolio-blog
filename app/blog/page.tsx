...
export default async function BlogPage({ searchParams }: BlogPageProps) {
  ...
  return (
    <div className="bg-gradient-to-r from-brandCol8/70 via-brandCol6/70 to-brandCol5/70 dark:from-brandCol3/70 dark:via-brandCol2/70 dark:to-brandCol3/70 flex justify-center border-b border-brandCol2 dark:border-brandCol1">
      <div className="container max-w-4xl py-6 lg:py-10 border border-dashed border-brandCol2 dark:border-brandCol1 dash-spacing m-2 lg:m-8 bg-brandCol1 dark:bg-brandCol3 shadow-xl">
